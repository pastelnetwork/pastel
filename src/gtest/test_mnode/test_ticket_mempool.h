...
public:
    ...
    MOCK_METHOD(void, getTicketTransactions, (const TicketID ticket_id, v_uint256& vTxid), (override));
    ...
    void Mock_AddTestData(const TicketID ticket_id, const size_t nCount, v_uint256& vTxid);
    void Mock_AddTestTxids(const TicketID ticket_id, const v_uint256& vTxid);

    void Call_getTicketTransactions(const TicketID ticket_id, v_uint256& vTxid)
    {
