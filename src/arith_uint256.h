...
public:
    ...
    base_uint& operator--()
    {
        // prefix operator
        int i = 0;
        while (--pn[i] == (uint32_t)-1 && i < WIDTH-1) //-V781
            i++;
        return *this;
    }
...
public:
     ...
     */
    arith_uint256& SetCompact(uint32_t nCompact, bool *pfNegative = NULL, bool *pfOverflow = nullptr);
