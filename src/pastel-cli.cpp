...
constexpr int DEFAULT_HTTP_CLIENT_TIMEOUT_SECS = 900;
...
string HelpMessageCli()
{
    ...
    strUsage += HelpMessageOpt("-rpcclienttimeout=<n>", strprintf(translate("Timeout in seconds during HTTP requests, or 0 for no timeout. (default: %d)"), DEFAULT_HTTP_CLIENT_TIMEOUT_SECS));
...
UniValue CallRPC(const string& strMethod, const UniValue& params)
{
    ...
    const int nHttpClientTimeout = static_cast<int>(GetArg("-rpcclienttimeout", DEFAULT_HTTP_CLIENT_TIMEOUT_SECS));
