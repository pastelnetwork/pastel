...
try: #For Pythonista:
    ...
    speech.say('Welcome to Pastel My ning!', 'fr_FR')
...
def print_mining_congratulations_message_func():
    ...
    printc('\n\n\nCongratulations, you just mined a valid Pastel block!\n\n\n', 'g')
...
def get_pastel_id_public_key_func(): #Placeholder
    my_pastel_id_public_key = '54fda990775aac0d54d8c5330cddbd52f5e4d816dd18a6f48b07f64c08f'
    return my_pastel_id_public_key
...
class solution_object(object):
  def __init__(self, block_transaction_data, block_count, difficulty_level, current_required_number_of_digits_of_precision, nonce_number, previous_block_final_hash, \
          ...
          self.miner_pastel_id_public_key = get_pastel_id_public_key_func()
...
if use_demo:
    if block_count == 0:
        ...
        previous_block_final_hash = int(hashlib.sha3_512(b'pastel').hexdigest(), 16)
