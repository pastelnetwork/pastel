...
dupe_detection_model_3_name, path_to_nsfw_detection_model_file = get_all_animecoin_parameters_func()
...
artist_final_signature_files_folder_path, dupe_detection_image_fingerprint_database_file_path, path_to_animecoin_artwork_metadata_template, path_where_animecoin_html_ticket_templates_are_stored = get_all_animecoin_directories_func()
