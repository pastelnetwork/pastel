...
def write_pastel_public_and_private_key_to_file_func(pastel_id_public_key_b16_encoded, pastel_id_private_key_b16_encoded):
...
def import_pastel_public_and_private_keys_from_pem_files_func(use_require_otp):
    #use_require_otp = 1
    pastel_id_keys_storage_folder_path = os.getcwd() + os.sep + 'pastel_id_key_files' + os.sep
    if not os.path.isdir(pastel_id_keys_storage_folder_path):
...
if use_demonstrate_eddsa_crypto:
    ...
    pastel_id_signature_b16_encoded = pastel_id_write_signature_on_data_func(input_data, pastel_id_private_key_b16_encoded, pastel_id_public_key_b16_encoded)
    verified = pastel_id_verify_signature_with_public_key_func(input_data, pastel_id_signature_b16_encoded, pastel_id_public_key_b16_encoded)
