...
constexpr uint32_t APPROX_RELEASE_HEIGHT = 565'000;
constexpr int WEEKS_UNTIL_DEPRECATION = 2 * 52; // 2 years
constexpr uint32_t DEPRECATION_HEIGHT = APPROX_RELEASE_HEIGHT + (WEEKS_UNTIL_DEPRECATION * 7 * 24 * 24);

// Number of blocks before deprecation to warn users
constexpr int DEPRECATION_WARN_LIMIT = 14 * 24 * 24; // 2 weeks
