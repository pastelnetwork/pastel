...
<--ANIM*/
        masterNodePlugin.netfulfilledman.RemoveFulfilledRequest(pnode->addr, "masternode-list-sync");
        masterNodePlugin.netfulfilledman.RemoveFulfilledRequest(pnode->addr, "masternode-payment-sync");
/*ANIM-->
        netfulfilledman.RemoveFulfilledRequest(pnode->addr, "governance-sync");
<--ANIM*/
        masterNodePlugin.netfulfilledman.RemoveFulfilledRequest(pnode->addr, "full-sync");
    });
}
...
<--ANIM*/
        ...
        {
            if(masterNodePlugin.netfulfilledman.HasFulfilledRequest(pnode->addr, "full-sync")) {
...
<--ANIM*/
            ...
            if(nRequestedMasternodeAssets == MASTERNODE_SYNC_LIST) {
                ...
                if(masterNodePlugin.netfulfilledman.HasFulfilledRequest(pnode->addr, "masternode-list-sync")) continue;
                masterNodePlugin.netfulfilledman.AddFulfilledRequest(pnode->addr, "masternode-list-sync");
            ...
            if(nRequestedMasternodeAssets == MASTERNODE_SYNC_MNW) {
                ...
                // only request once from each peer
                if(masterNodePlugin.netfulfilledman.HasFulfilledRequest(pnode->addr, "masternode-payment-sync")) continue;
                masterNodePlugin.netfulfilledman.AddFulfilledRequest(pnode->addr, "masternode-payment-sync");
