...
constexpr unsigned char TICKET_COMPRESS_ENABLE_MASK  = (1<<7); // using bit 7 to mark a ticket is compressed
constexpr unsigned char TICKET_COMPRESS_DISABLE_MASK = (~TICKET_COMPRESS_ENABLE_MASK);
