...
2. "creator-height"   (string, required) Block height at which action was called ('action_ticket' was created).
...
As json rpc:
    ...
    strprintf(R"(%s, "907e5e4c6fc4d14660a22afe2bdf6d27a3c8762abf0a89355bb19b7d9e7dc440", 213, 100, "jXYqZNPj21RVnwxnEJ654wEdzi7GZTZ5LAdiotBmPrF7pDMkpX1JegDMQZX55WZLkvy9fxNpZcbBJuE8QYUqBF", "passphrase")", 
        bRegisterAPI ? R"("register", "act")" : R"("activate", "action")")));
...
{
    RPC_CMD_PARSER2(ACTIVATE, params, nft, action);
