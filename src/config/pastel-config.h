/* src/config/pastel-config.h.  Generated from pastel-config.h.in by configure.  */
/* src/config/pastel-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Define to 1 to enable ticket compression */
#define ENABLE_TICKET_COMPRESS 1
...
/* Define to 1 if you have the `wininet' library (-lwininet). */
...
#define PACKAGE_BUGREPORT "https://github.com/PastelNetwork/Pastel/issues"
