...
class WalletBackupTest(BitcoinTestFramework):
    ...
    def run_test(self):
        log.info("Generating initial blockchain")
        ...
        assert_equal(self.nodes[2].getbalance(), self._reward)
        ...
        # 114 are mature, so the sum of all wallets should be 114 * self._reward
        assert_equal(total, 114*self._reward)

        ##
        # Test restoring spender wallets from backups
        ##
        log.info("Restoring using wallet.dat")
        self.stop_three()
        self.erase_three()
        ...
        log.info("Restoring using dumped wallet")
        self.stop_three()
        self.erase_three()
