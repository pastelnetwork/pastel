...
class MasterNodeTicketsTest(MasterNodeCommon):
    ...
    def run_test(self):
        ...
        self.initialize()
        self.register_nft_reg_ticket("key1", "key2")
        self.register_nft_act_ticket()
        self.register_nft_sell_ticket()
    ...
    def register_nft_reg_ticket(self, key1, key2):
        ...
        print("The NFT registration ticket has been created")
    ...
    def register_nft_act_ticket(self):
        ...
        self.art_ticket1_act_ticket_txid = \
            self.nodes[self.non_mn3].tickets("register", "act", self.art_ticket1_txid,
        ...
        print("The NFT activation ticket has been created")

    # ===============================================================================================================
    def register_nft_sell_ticket(self):
        ...
        print("The NFT sell ticket has been created")

    # ===============================================================================================================
    def register_nft_buy_ticket(self):
        print("== Create the NFT buy ticket ==")

        cover_price = self.art_copy_price + max(10, int(self.art_copy_price / 100))

        # send coins for 2 copies
    ...
    # ===============================================================================================================
    def register_nft_trade_ticket(self):
        ...
        self.nodes[self.non_mn4].sendtoaddress(consaddress, coins_before, "", "", True)
        ...
        print("The NFT trade ticket has been created")
