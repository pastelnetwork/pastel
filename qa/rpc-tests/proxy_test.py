#!/usr/bin/env python3
# Copyright (c) 2015-2016 The Pastel Core developers
...
'''
Test plan:
- Start pasteld's with different proxy configurations
- Use addnode to initiate connections
- Verify that proxies are connected to, and the right connection command is given
- Proxy configurations to test on pasteld side:
...
class ProxyTest(BitcoinTestFramework):        
    ...
    def node_test(self, node, proxies, auth, test_onion=True):
        ...
        # Note: pasteld's SOCKS5 implementation only sends atyp DOMAINNAME, even if connecting directly to IPv4/IPv6
