...
class MasterNodeMainTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # print(self.nodes[1].masternode("list"))
        # print(self.nodes[2].masternode("list"))
        ...
        print(self.nodes[1].masternode("list"))
        print(self.nodes[2].masternode("list"))
        print(self.nodes[3].masternode("list"))
        assert_equal(self.nodes[0].masternode("list")[mnId], "ENABLED")
        assert_equal(self.nodes[1].masternode("list")[mnId], "ENABLED")
        assert_equal(self.nodes[2].masternode("list")[mnId], "ENABLED")
        ...
        print("Stopping node 0 - Masternode...")
        stop_node(self.nodes[0],0)
        print("Wating 315 seconds...")
        time.sleep(315)
        print(self.nodes[1].masternode("list"))
        print(self.nodes[2].masternode("list"))
        print(self.nodes[3].masternode("list"))
        assert_equal(self.nodes[1].masternode("list")[mnId], "EXPIRED")
        assert_equal(self.nodes[2].masternode("list")[mnId], "EXPIRED")
        assert_equal(self.nodes[3].masternode("list")[mnId], "EXPIRED")
        ...
        assert_equal(self.nodes[2].masternode("list")[mnId], "EXPIRED")
        assert_equal(self.nodes[3].masternode("list")[mnId], "EXPIRED")
        print("Wating 630 seconds...")
        time.sleep(630)
        print(self.nodes[1].masternode("list"))
        print(self.nodes[2].masternode("list"))
        print(self.nodes[3].masternode("list"))
        assert_equal(self.nodes[1].masternode("list")[mnId], "NEW_START_REQUIRED")
        assert_equal(self.nodes[2].masternode("list")[mnId], "NEW_START_REQUIRED")
        assert_equal(self.nodes[3].masternode("list")[mnId], "NEW_START_REQUIRED")
        print("Starting node 0 as Masternode again...")
        self.nodes.append(start_node(0, self.options.tmpdir, ["-debug=masternode", "-masternode", "-txindex=1", "-reindex", "-masternodeprivkey=91sY9h4AQ62bAhNk1aJ7uJeSnQzSFtz7QmW5imrKmiACm7QJLXe"]))
        connect_nodes_bi(self.nodes,0,1)
        connect_nodes_bi(self.nodes,0,2)
        ...
        assert_equal(self.nodes[1].masternode("list")[mnId], "PRE_ENABLED")
        assert_equal(self.nodes[2].masternode("list")[mnId], "PRE_ENABLED")
        assert_equal(self.nodes[3].masternode("list")[mnId], "PRE_ENABLED")
        print("Wating 120 seconds...")
        time.sleep(120)
        print(self.nodes[0].masternode("list"))
        print(self.nodes[1].masternode("list"))
