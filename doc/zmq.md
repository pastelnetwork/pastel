...
For instance:
    ...
    $ animecoind -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubrawtx=ipc:///tmp/animecoind.tx.raw
...
From the perspective of animecoind, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into animecoind directly. Furthermore, no information is
...
using. animecoind appends an up-counting sequence number to each
