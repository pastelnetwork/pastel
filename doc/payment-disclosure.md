...
This is an experimental feature.  Enable it by launching `pasteld` with flags:

    pasteld -experimentalfeatures -paymentdisclosure -debug=paymentdisclosure -txindex=1

These flags can also be set as options in `pastel.conf`.
...
Alice the customer sends 10 PSL to Bob the merchant at the shielded address shown on their website.  However, Bob is not sure if he received the funds.
...
Generate a payment disclosure for the first joinsplit, second output (index starts from zero):
    ...
    pastel-cli z_getpaymentdisclosure 79189528d611e811a1c7bb0358dd31343033d14b4c1e998d7c4799c40f8b652b 0 1 "Hello"
...
To validate the payment disclosure:
    ...
    pastel-cli z_validatepaymentdisclosure HEXDATA
